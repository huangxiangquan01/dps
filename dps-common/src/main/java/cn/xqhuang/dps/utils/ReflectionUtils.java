...
public abstract class ReflectionUtils {
    ...
    public static List<Field> findField(Class<?> clazz) {
        return findFieldExceptSuperclass(clazz, null);
    }
     ...
     *
     * @param clazz      类信息
     * @param superclass 忽略的继承类
     * @return 字段信息
     */
    public static List<Field> findFieldExceptSuperclass(Class<?> clazz, Class<?> superclass) {
